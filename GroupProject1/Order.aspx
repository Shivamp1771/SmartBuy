<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Order.aspx.cs" Inherits="GroupProject1.Order" %>
<%@ MasterType VirtualPath="~/Site.Master" %>


<asp:Content ID="BodyContent" ContentPlaceHolderID="mainPlaceholder" runat="server">
    <div class="row"><%-- row 1 --%>
        <div class="col-sm-8 main-1"><%-- product drop down and info column --%>
            <div class="form-group">
                <label class="col-sm-5 main-content">Please select a product:</label>
        ...
        <div class="col-sm-4"><%-- product image column --%>
            <asp:Image ID="imgProduct" class="pro_img" runat="server" />
        </div>
    <div class="row"><%-- row 2 --%>
        <div class="col-sm-12 main-2">
            <div class="form-group">
